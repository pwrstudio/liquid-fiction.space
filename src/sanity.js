...
const serializers = {
  types: {
    audioFile: (props) => {
      // console.dir(props)
      const audioUrl =
        "https://cdn.sanity.io/files/ylcal1e4/production/" +
        props.node.audio.asset._ref.replace("file-", "").replace("-mp3", ".mp3")
      return h("audio.editorial-audio", { src: audioUrl, controls: true })
    },
  },
}
...
const hanniSerializers = {
  ...
  types: {
    block: (props) => {
      ...
      if (style === "h1") return h("h1", {}, props.children)
    ...
    videoBlock: (props) => {
      // console.dir(props)
      const videoUrl =
        "https://cdn.sanity.io/files/em610obk/production/" +
    ...
    audioBlock: (props) => {
      ...
      const audioUrl =
        ...
        props.node.audioFile.asset._ref
          .replace("file-", "")
          .replace("-mp3", ".mp3")
      return h("audio", { src: audioUrl, controls: true })
    },
  },
}
